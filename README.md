...
- **`bv41` Decoder:** Standalone decoding of Apple's `Compression.framework` LZ4 container format, targeting MacStadium Orka VM image layers and APFS snapshots without requiring an Apple runtime.
